...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleEntityAlreadyEx(AlreadyExistException ex, WebRequest request) {
        ApiError apiError = new ApiError("Already Exist Exception", ex.getMessage());
